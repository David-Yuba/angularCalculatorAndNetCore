...
- Create Angular project with ng: `ng new calculatorapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`calculatorapp.client.esproj`).
